...
#define POOL_STATUS_FINAXLPE_TRANSACTION       4 // master node will broadcast what it accepted
...
{
public:
    /// Is the inputs associated with this public key? (and there is 5000 XLP - checking if valid masternode)
