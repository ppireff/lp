...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeLightpayAmount"))
        settings.setValue("nAnonymizeLightpayAmount", 1000);
    nAnonymizeLightpayAmount = settings.value("nAnonymizeLightpayAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeLightpayAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeLightpayAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeLightpayAmount:
            return QVariant(nAnonymizeLightpayAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeLightpayAmount:
            nAnonymizeLightpayAmount = value.toInt();
            settings.setValue("nAnonymizeLightpayAmount", nAnonymizeLightpayAmount);
            emit AnonymizeLightpayAmountChanged(nAnonymizeLightpayAmount);
            break;
        default:
            break;
        }
