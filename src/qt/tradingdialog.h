...
private slots:
    ...
    QString BuyXLP(QString OrderType, double Quantity, double Rate);
    QString SellXLP(QString OrderType, double Quantity, double Rate);
