#include "addeditlightpaynode.h"
#include "ui_addeditlightpaynode.h"
...
AddEditLightpayNode::AddEditLightpayNode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddEditLightpayNode)
{
    ui->setupUi(this);
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 500 XLP TXID");
...
AddEditLightpayNode::~AddEditLightpayNode()
{
    delete ui;
}


void AddEditLightpayNode::on_okButton_clicked()
{
...
void AddEditLightpayNode::on_cancelButton_clicked()
{
    reject();
}

void AddEditLightpayNode::on_AddEditAddressPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->addressLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditLightpayNode::on_AddEditPrivkeyPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->privkeyLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditLightpayNode::on_AddEditTxhashPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
