...
int nAnonymizeLightpayAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Lightpay
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Lightpay
    // Mac: ~/Library/Application Support/Lightpay
    // Unix: ~/.lightpay
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lightpay";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "lightpay.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "lightpayd.pid"));
