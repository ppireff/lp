...
unsigned int nStakeMinAge = 8 * 60 * 60; // 1 hour
...
const string strMessageMagic = "Lightpay Signed Message:\n";
...
/*
 ...
 1y = 12 x 44k = 528k
 T + 3 months 25 XLP (Pow + Pos 12.5) / (Mns 12.5) > 50% Pow + Pos & 50% Mns -> 45k+44k = 89 k
 T + 1 Year 21.5 XLP (Pow + Pos 10.2) / (Mns 11.05) > 48% Pow + Pos & 52% Mns -> 45k+528k = 573 k
 T + 2 Year 19.47 XLP (Pow + Pos 8.96) / (Mns 10.51) > 46% Pow + Pos & 54% Mns -> 573k+528k = 1101 k
 T + 3 Year 17.85 XLP (Pow + Pos 7.49) / (Mns 10.3) > 42% Pow + Pos & 58% Mns -> 1629 k
 T + 4 Year 16.36 XLP (Pow + Pos 6.21) / (Mns 10.14) > 38% Pow + Pos & 62% Mns -> 2157 k
 T + 5 Year 15 XLP (Pow + Pos 5.10) / (Mns 9.90) > 34% Pow + Pos & 66% Mns -> 2685 k
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight > 1000 * 1000 && nHeight <= 2000 * 1000) {
        nSubsidy = 6 * COIN;
    }
    else if (nHeight > 2000 * 1000) {
