...
#ifndef BITCOIN_SERIAXLPE_H
#define BITCOIN_SERIAXLPE_H
...
#define IMPLEMENT_SERIAXLPE(statements)    \
 ...
 * code. Adding "ADD_SERIAXLPE_METHODS" in the body of the class causes these wrappers to be
 * added as members.
 */
#define ADD_SERIAXLPE_METHODS                                                          \
...
//
// Support for IMPLEMENT_SERIAXLPE and READWRITE macro
//
